...
<a name="#text-templates-post--get"></a>Text Templates (POST / GET)
-------------
...
<a name="#texts-post"></a>Texts (POST)
-------------
...
<a name="#stories-post--get"></a>Stories (POST / GET)
-------------
...
<a name="#social-connect-post"></a>Social Connect (POST)
-------------
...
<a name="#social-account-groups-post--get"></a>Social Account Groups (POST / GET)
-------------
